...
<head>
    ...
    <title>Home Page Purchase Order</title>
                ...
                <ul id="side-main-menu" class="side-menu list-unstyled">
                    ...
                    <li class="active"><a href="#purchase" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-bar-chart"></i>Transaction</a>
                        <ul id="purchase" class="collapse list-unstyled show">
                            <li class="active"><a href="https://EZOfficeInventory.azurewebsites.net/purchase">Purchase Order</a></li>
					...
					<div class="card-body">
						<div class="col-md-12 commen-space">
							<div class="form-group row">
								<a href="https://EZOfficeInventory.azurewebsites.net/AddNewPO">Add New PO Entry</a>
							</div>
...
function loadHomePGData() {
	$.ajax({
		//url: '/EZOfficeInventory/get-All-PO-HomePG-Data',
		 url: 'https://EZOfficeInventory.azurewebsites.net/get-All-PO-HomePG-Data',
     	type: 'POST',
		   ...
		   data: JSON.stringify(
		   	...
		   	success: function (data) {
		        ...
		        for(var i=0;i<data.length;i++){
		        	viewBtn= '<button type="button" class="common-btn btn-sm" id="viewbtn" onclick=OpenEntryPG("view",'+data[i].ipoId+')>View</button>';
		        	editBtn= '<button type="button" class="common-btn gray-btn btn-sm" id="editbtn" onclick=OpenEntryPG("edit",'+data[i].ipoId+')>Edit</button>';
		        	$('#tdata').append(
		        		'<tr>'+
		        		'<td hidden>'+data[i].ipoId +'</td>'+
		        		'<td>'+data[i].poNo+'</td>'+
		        		'<td>'+data[i].poDate+'</td>'+
...
function OpenEntryPG(sMode, poId) {
	srchData = {
			"searchVarData" : sMode,
			"poId" : poId
		};
		//window.location.href = "/EZOfficeInventory/OpenPurchaseOrder?"
