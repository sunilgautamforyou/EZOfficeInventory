					...
					<div class="card-body">
						<div class="col-md-12 commen-space">
							<div class="form-group row">
								<a href="https://EZOfficeInventory.azurewebsites.net/AddNewSalesOrder">Add New Sales Order</a>
							</div>
...
function loadCustomerHomePGData() {
	$.ajax({
		...
		url: 'https://EZOfficeInventory.azurewebsites.net/get-All-SO-HomePG-Data',
     	type: 'POST',
...
function OpenEntryPG(sMode, salesOrderId) {
	...
	//window.location.href = "/EZOfficeInventory/OpenSalesOrder?"
     window.location.href = "https://EZOfficeInventory.azurewebsites.net/OpenSalesOrder?"
			+ $.param(srchData);
}
</script>
</html>