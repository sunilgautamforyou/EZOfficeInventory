					...
					<div class="card-body">
						<div class="col-md-12 commen-space">
							<div class="form-group row">
								<a href="https://ezofficeinventory.azurewebsites.net/AddNewpartyMaster">Add Party Master Entry</a>
							</div>
...
function loadHomePGData() {
	...
	function OpenEntryPG(sMode, partyId) {
	    ...
	    window.location.href = "https://EZOfficeInventory.azurewebsites.net/OpenParty?"
				+ $.param(srchData);
	}
</script>
</html>