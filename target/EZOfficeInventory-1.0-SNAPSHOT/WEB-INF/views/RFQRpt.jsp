...
<td>:</td>
<td><h1>${rfqRpt.getCustomerName()}</h1></td>
</tr>
<tr>
<td class="textclr">
Tower No
...
<td>:</td>
<td>${rfqRpt.getCutomerMobileNo()}</td>
</tr>
</table>
</div>
...
<table class="text-section" style="line-height: 23px; text-align: left; float:right; padding-right: 20px;">
    <tr>
        ...
        <td>:</td>
        <td><h1>${rfqRpt.getRfqNumber()}</h1></td>
        </tr>
        <tr>
            <td class="textclr1">
            Quotation Date
