					...
					<div class="card-body">
						<div class="col-md-12 commen-space">
							<div class="form-group row">
								<a href="https://salepurchasecompany.co.in/AddNewUOM">Add New UOM Entry</a>
							</div>
...
function loadHomePGData() {
	$.ajax({
		...
		url: 'https://salepurchasecompany.co.in/get-all-HomePG-uom-data',
     	type: 'POST',
	...
	function OpenEntryPG(sMode, uomId) {
		...
		window.location.href = "https://salepurchasecompany.co.in/OpenUOM?"		
				+ $.param(srchData);
	}
</script>
</html>