...
<head>
    ...
    <title>Unit Master Home Page</title>
                ...
                <ul id="side-main-menu" class="side-menu list-unstyled">
                    <li class="active"><a href="#dashboard" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Master</a>
                        <ul id="dashboard" class="collapse list-unstyled show">
                            ...
                            <li class="active"><a href="https://EZOfficeInventory.azurewebsites.net/uomMaster">UOM Master</a></li>
					...
					<div class="card-body">
						<div class="col-md-12 commen-space">
							<div class="form-group row">
								<a href="https://EZOfficeInventory.azurewebsites.net/AddNewUOM">Add New UOM Entry</a>
							</div>
...
function loadHomePGData() {
	$.ajax({
		//url: '/EZOfficeInventory/get-all-HomePG-uom-data',
		url: 'https://EZOfficeInventory.azurewebsites.net/get-all-HomePG-uom-data',
     	type: 'POST',
		   	...
		   	success: function (data) {
		        ...
		        var k=1;
		          $('#mainHead').html(
		        		...
		        		// '<th>Sr. No</th>'+
		                 '<th hidden>uomId</th>'+
		                 '<th style="width:30%">Detail Description</th>'+
		                 '<th class="dlySlsFcstWkTtl">Short Name</th>'+
		                 '<th>Created By</th>'+
		                 '<th>Created Date</th>'+
		                 '<th >Action</th>'+
		                 '</tr>'	
		        ...
		        for(var i=0;i<data.length;i++){
		        	viewBtn= '<button type="button" class="common-btn btn-sm" id="viewbtn" onclick=OpenEntryPG("view",'+data[i].uomId+')>View</button>';
		        	editBtn= '<button type="button" class="common-btn gray-btn btn-sm" id="editbtn" onclick=OpenEntryPG("edit",'+data[i].uomId+')>Edit</button>';
		        	$('#tdata').append(
		        		'<tr>'+
	...
	function OpenEntryPG(sMode, uomId) {
		srchData = {
			"searchVarData" : sMode,
			"uomId" : uomId
		};
		//window.location.href = "/EZOfficeInventory/OpenUOM?"
		window.location.href = "https://EZOfficeInventory.azurewebsites.net/OpenUOM?"		
				+ $.param(srchData);
	}
</script>
</html>