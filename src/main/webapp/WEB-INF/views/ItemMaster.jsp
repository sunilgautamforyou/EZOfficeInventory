 ...
 */	
			...
			$("#alertMsg").append("Please enter details then click on search button. ");
			   ...
			   $.ajax({
				  // url: '/EZOfficeInventory/get-uom-search-list',
				   url: 'https://EZOfficeInventory.azurewebsites.net/get-uom-search-list',
				    type: 'Post',
    	...
    	if (validate()==true) {
    		if (confirm('Are you sure you want to save?')) {
    			...
    			console.log(data);
 				...
 				xhr.open("POST", "https://EZOfficeInventory.azurewebsites.net/Create-New-ItemMaster", true);
	...
	function exitToHomePage() {
		...
		location.href = "https://EZOfficeInventory.azurewebsites.net/ItemMaster";
	}    
    ...
    function fillSubCategoryMaster(categId) {
    	$.ajax({
    		...
    		url: 'https://EZOfficeInventory.azurewebsites.net/getSubCategoryItem',
         	type: 'POST',
    		contentType: 'application/json',	
    		   data: JSON.stringify(
    		   	{
