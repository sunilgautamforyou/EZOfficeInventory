...
<head>
    ...
    <title>Home Page Item Master</title>
...
<body>
                ...
                <ul id="side-main-menu" class="side-menu list-unstyled">
                    <li class="active"><a href="#dashboard" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Master</a>
                        <ul id="dashboard" class="collapse list-unstyled show">
                            ...
                            <li class="active"><a href="https://EZOfficeInventory.azurewebsites.net/ItemMaster">Item Master</a></li>
 ...
 <div class="page">
        ...
        <div class="breadcrumb-holder">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item active">Item Master Home Page</li>
                </ul>
            </div>
        </div>
        <section>
					...
					<div class="card-body">
						<div class="col-md-12 commen-space">
							<div class="form-group row">
								<a href="https://ezofficeinventory.azurewebsites.net/AddNewItemMaster">Add New Item Entry</a>
							</div>
...
function loadHomePGData() {
	$.ajax({
		//url: '/EZOfficeInventory/get-all-HomePG-Item-data',
		url: 'https://EZOfficeInventory.azurewebsites.net/get-all-HomePG-Item-data',
     	type: 'POST',
		   ...
		   data: JSON.stringify(
		   	...
		   	success: function (data) {
		        ...
		        for(var i=0;i<data.length;i++){
		        	viewBtn= '<button type="button" class="common-btn btn-sm" id="viewbtn" onclick=OpenEntryPG("view",'+data[i].itemId+')>View</button>';
		        	editBtn= '<button type="button" class="common-btn gray-btn btn-sm" id="editbtn" onclick=OpenEntryPG("edit",'+data[i].itemId+')>Edit</button>';
		        	$('#tdata').append(
		        		'<tr>'+
	...
	function OpenEntryPG(sMode, partyId) {
		srchData = {
			"searchVarData" : sMode,
			"itemId" : partyId
		};
		//window.location.href = "/EZOfficeInventory/OpenItem?"
		window.location.href = "https://EZOfficeInventory.azurewebsites.net/OpenItem?"				
				+ $.param(srchData);
	}
</script>
</html>