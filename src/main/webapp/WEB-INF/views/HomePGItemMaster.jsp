					...
					<div class="card-body">
						<div class="col-md-12 commen-space">
							<div class="form-group row">
								<a href="https://salepurchasecompany.co.in/AddNewItemMaster">Add New Item Entry</a>
							</div>
...
function loadHomePGData() {
	$.ajax({
		...
		url: 'https://salepurchasecompany.co.in/get-all-HomePG-Item-data',
     	type: 'POST',
	...
	function OpenEntryPG(sMode, partyId) {
		...
		window.location.href = "https://salepurchasecompany.co.in/OpenItem?"				
				+ $.param(srchData);
	}
</script>
</html>