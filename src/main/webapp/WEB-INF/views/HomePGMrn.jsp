					...
					<div class="card-body">
						<div class="col-md-12 commen-space">
							<div class="form-group row">
								<a href="https://EZOfficeInventory.azurewebsites.net/AddNewMRN">Add New MRN Entry</a>
...
function loadHomePGData() {
	$.ajax({
		//url: '/EZOfficeInventory/getAllMrnHomePGDataObj',
		 url: 'https://EZOfficeInventory.azurewebsites.net/getAllMrnHomePGDataObj',
     	type: 'POST',
...
function OpenEntryPG(sMode, mrnId) {
	srchData = {
		...
		//window.location.href = "/EZOfficeInventory/OpenMrnEntry?"
		 window.location.href = "https://EZOfficeInventory.azurewebsites.net/OpenMrnEntry?"
				+ $.param(srchData);
	}	
</script>
</html>