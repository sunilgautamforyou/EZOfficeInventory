...
<td>:</td>
<td><h1>${soRpt.getCustomerName()}</h1></td>
</tr>
<tr>
<td class="textclr">
Tower No
...
<td>:</td>
<td>${soRpt.getCutomerMobileNo()}</td>
</tr>
</table>
</div>
...
<table class="text-section" style="line-height: 23px; text-align: left; float:right; padding-right: 20px;">
    <tr>
        ...
        <td>:</td>
        <td><h1>${soRpt.getSalesOrderNumber()}</h1></td>
        </tr>
        <tr>
            <td class="textclr1">
            Sales Order Date
    ...
    <tr>
        ...
        <td>:</td>
        <td><h1>${soRpt.getRfQNumber()}</h1></td>
        </tr>
        <tr>
            <td class="textclr1">
            Quotation Date
