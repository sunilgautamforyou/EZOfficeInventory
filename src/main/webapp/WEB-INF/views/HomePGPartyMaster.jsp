...
<head>
    ...
    <title>Party Master Home Page</title>
                ...
                <ul id="side-main-menu" class="side-menu list-unstyled">
                    <li class="active"><a href="#dashboard" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Master</a>
                        <ul id="dashboard" class="collapse list-unstyled show">
                            ...
                            <li class="active"><a href="https://salepurchasecompany.co.in/partyMaster">Party Master</a></li>
                       </ul>
                    </li>
					...
					<div class="card-body">
						<div class="col-md-12 commen-space">
							<div class="form-group row">
								<a href="https://salepurchasecompany.co.in/AddNewpartyMaster">Add Party Master Entry</a>
							</div>
...
function loadHomePGData() {
		   ...
		   data: JSON.stringify(
		   	...
		   	success: function (data) {
		        ...
		        for(var i=0;i<data.length;i++){
		        	viewBtn= '<button type="button" class="common-btn btn-sm" id="viewbtn" onclick=OpenEntryPG("view",'+data[i].partyId+')>View</button>';
		        	editBtn= '<button type="button" class="common-btn gray-btn btn-sm" id="editbtn" onclick=OpenEntryPG("edit",'+data[i].partyId+')>Edit</button>';
		        	$('#tdata').append(
		        		'<tr>'+
	...
	function OpenEntryPG(sMode, partyId) {
		...
		//window.location.href = "/EZOfficeInventory/OpenParty?"
	    window.location.href = "https://salepurchasecompany.co.in/OpenParty?"
				+ $.param(srchData);
	}
</script>
</html>