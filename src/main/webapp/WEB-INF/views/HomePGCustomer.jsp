...
<head lang="en">
    ...
    <!-- Bootstrap CSS-->
    <link rel="stylesheet" href="https://EZOfficeInventory.azurewebsites.net/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://EZOfficeInventory.azurewebsites.net/css/dataTables.bootstrap4.min.css">
    <!-- Font Awesome CSS-->
    <link rel="stylesheet" href="https://EZOfficeInventory.azurewebsites.net/css/font-awesome.min.css">
    <!-- Fontastic Custom icon font-->
    <link rel="stylesheet" href="https://EZOfficeInventory.azurewebsites.net/css/fontastic.css">
    <!-- Google fonts - Roboto -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700">
    <!-- Custom Scrollbar-->
    <link rel="stylesheet" href="https://EZOfficeInventory.azurewebsites.net/css/jquery.mCustomScrollbar.css">
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="https://EZOfficeInventory.azurewebsites.net/css/style.css">
    <link rel="stylesheet" href="https://EZOfficeInventory.azurewebsites.net/css/responsive.css">
                ...
                <ul id="side-main-menu" class="side-menu list-unstyled">
                    <li class="active"><a href="#dashboard" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Master</a>
                        <ul id="dashboard" class="collapse list-unstyled show">
                            ...
                            <li class="active"><a href="https://EZOfficeInventory.azurewebsites.net/dashBoard">Customer Master</a></li>
...
<div class="page">
                ...
                <div class="container-fluid">
                    <div class="navbar-holder d-flex align-items-center justify-content-between">
                        ...
                        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center top-menu">
                            ...
                            <!-- Log out-->
							<li class="nav-item"><a href="https://ezofficeinventory.azurewebsites.net/" class="nav-link logout"> <span class="d-none d-sm-inline-block">Logout</span><i class="fa fa-sign-out"></i></a></li>                        </ul>
                    </div>
                </div>
            </nav>
        </header>
					...
					<div class="card-body">
						<div class="col-md-12 commen-space">
							<div class="form-group row">
								<a href="https://EZOfficeInventory.azurewebsites.net/AddNewCustomerMaster">Add New Customer Entry</a>
							</div>
    ...
    <!--Modal Popup Area-->
    <!-- JavaScript files-->
    <script src="https://EZOfficeInventory.azurewebsites.net/js/jquery.min.js"></script>
    <script src="https://EZOfficeInventory.azurewebsites.net/js/popper.min.js"></script>
    <script src="https://EZOfficeInventory.azurewebsites.net/js/jquery.mCustomScrollbar.concat.min.js"></script>
    <!-- Main File-->
    <script src="https://EZOfficeInventory.azurewebsites.net/js/custom.js"></script>          
</body>
...
function OpenEntryPG(sMode, customerId) {
	...
	window.location.href = "https://EZOfficeInventory.azurewebsites.net/OpenCustomer?"
			+ $.param(srchData);
}
</script>
</html>