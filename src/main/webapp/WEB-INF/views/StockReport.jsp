            ...
            <div class="main-menu">
                <ul id="side-main-menu" class="side-menu list-unstyled">
                   ...
                   <li class="active"><a href="#reports" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-book"></i>Reports</a>
                  	...
                  	<li class="active"><a href="https://EZOfficeInventory.azurewebsites.net/stockReport">Stock Report</a></li>
                  	</ul>
                  </li>	
                 	</ul>
            </div>
    ...
    <script src="js/custom.js"></script>
     ...
     function fillItemOnCategoryChange(categoryId) {
    	 $.ajax({
    		 ...
    		 url: 'https://EZOfficeInventory.azurewebsites.net/getItemDetailStockReport',
    		 type: 'POST',
    		 contentType: 'application/json',
    		 data: JSON.stringify(
    		  {
     ...
     function getStockReportData() {
    	 if (validate()==true) {
    		 $.ajax({
    			 ...
    			 url: 'https://EZOfficeInventory.azurewebsites.net/getDataForStockMasterReport',
    			 type: 'Post',
    			 contentType: 'application/json',
			   	 data: JSON.stringify(
				 {
