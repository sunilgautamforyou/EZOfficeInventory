...
<body>
    ...
    customerDataArray=[];
    	...
    	$('#sotable').on('keypress','#txtRate',function(event) {
     	...
     	function saveRFQData() {
     		if (validate() == true) {
    			...
    			xhr.open("POST", "https://salepurchasecompany.co.in/Save-RFQ-Data", true);
    	...
    	function exitToHomePage() {
    		...
    		location.href = "https://salepurchasecompany.co.in/rfq";
    	}
    	function refreshData() {
    		//location.href = "/EZOfficeInventory/AddNewSalesOrder";
    		location.href = "https://salepurchasecompany.co.in/AddNewRFQ";
    	}    
		function vwReport() {
			srchData = {
					"rfQId" : rfqId
				...
				var poLink = "https://salepurchasecompany.co.in/PrintRFQ?"+ $.param(srchData);
				popitup(poLink);
		}
